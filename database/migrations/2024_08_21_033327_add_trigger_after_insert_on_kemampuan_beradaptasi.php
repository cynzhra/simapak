...
return new class extends Migration
{
    ...
    ');
        ...
        DB::unprepared('
            CREATE TRIGGER calculate_adaptasi_score_update
            BEFORE UPDATE ON kemampuan_beradaptasi
            FOR EACH ROW
            BEGIN
            SET NEW.bobot_nilai = (
                    NEW.fleksibilitas * 0.20 +
    ...
    public function down(): void
    {
        ...
        DB::unprepared('DROP TRIGGER IF EXISTS calculate_adaptasi_score_update');
    }
};
