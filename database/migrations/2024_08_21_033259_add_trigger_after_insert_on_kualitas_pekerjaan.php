...
return new class extends Migration
{
    ...
    DB::unprepared('
    CREATE TRIGGER calculate_kualitas_pekerjaan_score_update
    BEFORE UPDATE ON kualitas_pekerjaan
    FOR EACH ROW
    BEGIN
    SET NEW.bobot_nilai = (
                    NEW.ketepatan * 0.30 +
    ...
    public function down(): void
    {
        ...
        DB::unprepared('DROP TRIGGER IF EXISTS calculate_kualitas_pekerjaan_score_update');
    }
};